        ...
        {!isFirstRun && (
          <section className="workbench" id="console">
            ...
            <details className="workbench-details" open={!drifted}>
              <summary>
                {drifted ? "Inspect the live evidence and explore manually" : "Live action workbench"}
              </summary>
              {drifted && (
            ...
            <div>
              ...
              <div className="panel" style={{ marginTop: 28 }}>
                ...
                <p className="note">
                  Every button drives the real domain against a real DataHub instance. Nothing here
                  is simulated.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="panel" style={{ marginTop: 28 }} id="policy">
                ...
                <p className="note">
                  ...
                  fields it depends on — exactly those fields are fingerprinted into the Passport,
                  and a signed authorization dies if the policy set itself changes.
                </p>
